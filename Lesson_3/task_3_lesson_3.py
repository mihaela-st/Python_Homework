...
# CODUL TĂU VINE MAI JOS:
adunare=number+number3
print(adunare)
scadere=number-number3
print(scadere)
inmultire=number*number3
print(inmultire)
impartire=number/number3
print(impartire)
modulo=number%number3
print(modulo)
exponentiere=number**number3
print(exponentiere)
impartire_intreaga=number//number3
