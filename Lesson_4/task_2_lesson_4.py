...
# Identifică indexul unde se află `a` în string-ul creat folosind altă metodă
...
# CODUL TĂU VINE MAI JOS:
formatted_string = "{} și {}".format(name, name2)
# CODUL TĂU VINE MAI SUS:
